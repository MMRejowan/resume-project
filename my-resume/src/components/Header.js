            ...
            <div className="header-grid">
                <div className="profile-photo">
                    <div className="profile-image-container">
                        {imageError ? (
                            <div className="profile-image-fallback">MMR</div>
                        ) : (
                            <img 
                ...
                <div className="header-content">
                    <h1 className="name">
                        <TypingText text="Mushtaq Mohd Rejowan" speed={150} />
                    </h1>
                    ...
                    <div className="social-links">
                        <a href="https://www.linkedin.com/in/mmrejowan" target="_blank" rel="noopener noreferrer" className="social-link linkedin">
                            <svg className="social-icon linkedin-icon" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
                        ...
                        <a href="https://github.com/MMRejowan" target="_blank" rel="noopener noreferrer" className="social-link github">
                            <svg className="social-icon github-icon" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
